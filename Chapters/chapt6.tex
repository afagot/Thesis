...
\section{Certification of the CMS RPCROC prototype}
\label{chapt6:sec:Certification}
	
	\subsection{Preliminary tests with cosmic muons}
	
	\subsection{Certification campaign at the \acl{GIF++}}
