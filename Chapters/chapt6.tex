...
\label{chapt6:sec:candidates}
    ...
    \begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:INFN_StripPic} Picture of half the longitudinal \subref{fig:INFN_Readout:A} and of the top part of the transversal \subref{fig:INFN_Readout:B} strip panels. A INFN Tor Vergata FEB with disconnected coaxial cables is placed on the transversal plane to illustrate its final position.}
    \end{figure}
