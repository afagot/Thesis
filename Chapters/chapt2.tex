...
\begingroup\setlength{\intextsep}{0pt}\setlength{\columnsep}{15pt}
	...
	\begin{wrapfigure}{O}{0.45\linewidth}
		...
		\end{minipage}
		\caption{\label{fig:quantum-numbers} \subref{fig:quantum-numbers:A}: The orbits in which the electron may travel according to the Borh model of the hydrogen atom. An electron jumps between orbits and is accompanied by an emitted or absorbed amount of electromagnetic energy ($h\nu$).The orbits radius increases as $n^2$. \subref{fig:quantum-numbers:B}: Elliptical orbits with the same energy and quantized angular momentum $l= 0, 1,...,n-1$ in the case $n=5$. \subref{fig:quantum-numbers:C}: Illustration of quantum mechanical orbital angular momentum. The cones and plane represent possible orientations of the angular momentum vector for $l=2$ and $m=-2,-1,0,1,2$.}
		\vspace{-5pt}
	\end{wrapfigure}
...
\endgroup
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:spin} \subref{fig:spin:A}: The spectral lines of mercury vapor lamp anomalous Zeeman effect without magnetic field (A) and with magnetic field (B - transverse Zeeman effect \& C - longitudinal Zeeman effect). \subref{fig:spin:B}: Stern–Gerlach experiment: Silver atoms traveling through an inhomogeneous magnetic field and being deflected up or down depending on their spin.}
	\end{figure}
...
\begingroup\setlength{\intextsep}{0pt}\setlength{\columnsep}{15pt}
	...
	\begin{wrapfigure}{O}{0.45\linewidth}
		...
		\end{minipage}
		\caption{\label{fig:emulsions} \subref{fig:emulsions:A}: decay of a $\mu$-meson in an emulsion. \subref{fig:emulsions:B}: track of a $\pi$-meson in an emulsion signed by Lattes, Powell, and Occhialini.}
		\vspace{-5pt}
	\end{wrapfigure}
...
\begingroup\setlength{\intextsep}{10pt}\setlength{\columnsep}{15pt}
	...
	\begin{wrapfigure}{O}{.45\linewidth}
		\vspace{-10pt}
		\begin{minipage}{\linewidth}
			\centering\captionsetup[subfigure]{justification=centering}
		...
		\end{minipage}
		\caption{\label{fig:Eightfold} \subref{fig:Eightfold:A}: Meson octet. \subref{fig:Eightfold:B}: Baryon octet. \subref{fig:Eightfold:C}: Baryon decuplet.}
		\vspace{-5pt}
	\end{wrapfigure}
...
\endgroup
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:JPsi} Discovery of the $J/\Psi$ by both \subref{fig:JPsi:A} SPEAR (SLAC~\cite{RICHTER1974}) and \subref{fig:JPsi:B} AGS (BNL~\cite{TING1974}). In Figure~\subref{fig:JPsi:A}, the cross section versus energy is showed for (a) multi hadron final states, (b) $e^+e^-$ final states, and (c) $\mu^+\mu^-$, $\pi^+\pi^-$ and $K^+K^-$ final states.}
	\end{figure}
...
\begingroup\setlength{\intextsep}{0pt}\setlength{\columnsep}{15pt}
	...
	\begin{wrapfigure}{O}{.5\linewidth}
		...
		\end{minipage}
		\caption{\label{fig:pp-cross-section} \subref{fig:pp-cross-section:A}: Total proton-proton cross-section as a function of the collisions center-of-mass energy $\sqrt{s}$~\cite{ARKHIPOV2001} with cosmic-ray data from Akeno Observatory and Fly’s Eye Collaboration. \subref{fig:pp-cross-section:B}: Total proton-(anti)proton and interaction channel cross-sections in the \si{TeV} scale.}
	\end{wrapfigure}
...
\begingroup\setlength{\intextsep}{-15pt}\setlength{\columnsep}{15pt}
	...
	\begin{wrapfigure}{O}{.47\linewidth}
		\centering
		\vspace{15pt}
...
\endgroup
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:LHCQuadrupole} The LHC quadrupoles~\subref{fig:LHCQuadrupole:A} showed together with the magnetic fields and resulting focussing force applied on the beam by two consecutive quadrupoles~\subref{fig:LHCQuadrupole:B}.}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:Higgs} Distribution of the four-lepton invariant mass for the $ZZ \rightarrow 4l$ analysis as presented by both~\subref{fig:Higgs:A} ATLAS~\cite{ATLAS2012} and \subref{fig:Higgs:B} CMS~\cite{CMS2012} in 2012.}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:HL-LHC-Timeline} Detailed timeline projection of LHC and HL-LHC operation until 2039 showing the evolution of the instantaneous and integrated luminosity as designed~\subref{fig:HL-LHC-Timeline:A} and in the ultimate case where the instantaneous luminosity is increased to \Sci{7.5}{34}\siflux thanks to a new increase of instantaneous luminosity during Run 5~\subref{fig:HL-LHC-Timeline:B}~\cite{HLLHC2017,HLLHCPDR,PHASEIITP}.}
	\end{figure}
...
\endgroup
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:ECAL} \subref{fig:ECAL:A}: The \acl{ECAL}. \subref{fig:ECAL:B}: The lead tungstate crystals composing the ECAL.}
	\end{figure}
...
\endgroup
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:Muon} \subref{fig:Muon:A}: Barrel wheel with its detector rings and return yokes. \subref{fig:Muon:B}: CSC endcap disk with the two CSC stations. The outer station is made of \SI{10}{\deg} detectors while the inner station is made of \SI{20}{\deg} detectors. \subref{fig:Muon:C}: RPC endcap disk. The inner station is not equipped, leaving the inner CSC station visible.}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{\label{fig:CSC-layout} \subref{fig:CSC-layout:A}: Cathode strips and anode wire layout of a CSC panel. \subref{fig:CSC-layout:B}: Avalanche development and charge collection by anode wires and induction on cathode strips inside of a CSC panel.}
	\end{figure}
