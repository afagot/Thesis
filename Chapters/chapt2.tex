...
\label{chapt2:sec:phase-2}
	...
	\subsection{Phase-II upgrade of the DT system}
	\label{chapt2:ssec:DTP2}

	\subsection{Phase-II upgrade of the CSC system}
	\label{chapt2:ssec:CSCP2}

	\subsection{Phase-II upgrade of the RPC system}
	\label{chapt2:ssec:RPCP2}
...
\end{figure}
	...
	\subsection{Phase-II upgrade of the Level-1 trigger}
	\label{chapt2:ssec:L1tP2}
