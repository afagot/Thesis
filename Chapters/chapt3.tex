...
\label{chapt3:sec:HL-LHC}
	...
	\begin{figure}[H]
		...
		\includegraphics[width=1.2\linewidth]{fig/chapt3/HL-LHC-plan-2017.jpg}
...
\section{Phase-II upgrade of the DT system}
\label{chapt3:sec:DTP2}

\section{Phase-II upgrade of the CSC system}
\label{chapt3:sec:CSCP2}

\section{Phase-II upgrade of the RPC system}
\label{chapt3:sec:RPCP2}
...
\section{Phase-II upgrade of the Level-1 trigger}
