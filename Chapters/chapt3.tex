...
\label{sec:RateCapa}
	...
	\begin{figure}[!h]
		\begin{subfigure}{0.5\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/RPC_Charging_1.png}
			\caption{\label{fig:ElecCharge:A}}
		\end{subfigure}
		\begin{subfigure}{0.5\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/RPC_Charging_2.png}\\
			\caption{\label{fig:ElecCharge:B}}
		\end{subfigure}
		\begin{subfigure}{\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/RPC_Charging_3.png}
	...
	\begin{figure}[!h]
		\begin{subfigure}{0.5\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/RPC_Streamer_Mode.png}
			\caption{\label{fig:ModeSignal:A}}
		\end{subfigure}
		\begin{subfigure}{0.5\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/RPC_Avalanche_Mode.png}\\
	...
	\begin{figure}[!h]
		\begin{subfigure}{0.5\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/Double-gap-Sigmoid.png}\\
			\caption{\label{fig:DoubleGap:A}}
		\end{subfigure}
		\begin{subfigure}{0.5\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/Double-gap-Eff-95.png}
			\caption{\label{fig:DoubleGap:B}}
		\end{subfigure}
		\begin{subfigure}{\linewidth}
			\centering
			\includegraphics[width = 0.5\plotwidth]{fig/chapt3/Double-gap-Eff-Delta-90-10.png}
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width = 0.6\plotwidth]{fig/chapt3/MRPC-Layout.png}\\
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width = \plotwidth]{fig/chapt3/STAR-ToF.png}\\
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width = 0.7\plotwidth]{fig/chapt3/ALICE-Rate_Capability.png}\\
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width = 0.6\plotwidth]{fig/chapt3/Layout_charge_ratio.png}\\
	...
	\begin{figure}[!h]
		\centering
		\includegraphics[width = \plotwidth]{fig/chapt3/Layout_charge_distributions.png}\\
