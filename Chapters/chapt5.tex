...
\newpage
	...
	These fluctuations may arise due to different factors such as the distance from the source, the environmental conditions (gas and bunker temperature, gas relative humidity, environmental pressure), the presence or not of other experiments between the source and the trolley or the gamma current at which the detectors are irradiated during the ageing procedure. In order to have a better understanding, the monitoring of the environmental parameters, i.e. the gas relative humity and temperature both at the supply and at the exhaust of the trolley together with the humidity and temperature inside of the bunker and the environmental pressure, is showed in Figures~\ref{fig:GIFpp-Humidity}, \ref{fig:GIFpp-Temperature} and \ref{fig:GIFpp-Pressure}. In these Figures, the data are displayed with increasing integrated charge in the case of the RE2 and of the RE4 detectors for comparison purposes. Indeed, each value of integrated charge corresponds to a unique date.\\
