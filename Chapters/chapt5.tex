...
\endgroup
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:october-sig} Efficiency~\subref{fig:october-sig:A} and monitored currents of the bottom~\subref{fig:october-sig:B} and top narrow~\subref{fig:october-sig:C} gaps as a function of the effective voltage of the irradiated RE2 chamber during October 2018 testbeam period.}
	\end{figure}
...
\normalsize
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:GIFpp_wp_vs_rate} Superposition of the working voltage as a function of the gamma rate measured in each of the CMS RPCs installed at the GIF++ during the six test beam periods.}
	\end{figure}
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:GIFpp_cls_vs_rate} Superposition of the cluster size at working voltage as a function of the gamma rate measured in each of the CMS RPCs installed at the GIF++ during the six test beam periods.}
	\end{figure}
...
% BONUS Figures with superposition of the efficiency sigmoids first without irradiation and then with irradiation - it could be too much so I am not showing them at the moment.
...
%    	\end{subfigure}
%		\caption{\label{fig:GIFpp_eff_vs_HV_OFF} Summary of the efficiency sigmoids as a function of the effective voltage measured without irradiation with the CMS RPCs installed at the GIF++ during the six test beam periods.}
%	\end{figure}
%	
%	\begin{figure}[H]
%    	\begin{subfigure}{0.5\linewidth}
...
%    	\end{subfigure}
%		\caption{\label{fig:GIFpp_eff_vs_HV_600} Summary of the efficiency sigmoids as a function of the effective voltage measured with an irradiation close to \SIrate{600} with the CMS RPCs installed at the GIF++ during the six test beam periods.}
%	\end{figure}
