...
\begingroup\setlength{\intextsep}{5pt}\setlength{\columnsep}{15pt}
	...
	Nevertheless, the distribution shown in Figure~\ref{fig:SimResult:A} differs from the measured hit profile shown in Figure~\ref{fig:HitProf} as can be seen in Figure~\ref{fig:Data-Acc-Comp}. It is difficult to evaluate a systematic uncertainty on this geometrical correction for different reasons.\\
...
\newpage
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:Longevity} Example of current monitoring summary (top wide~\subref{fig:Longevity:A}, top narrow~\subref{fig:Longevity:B} and bottom~\subref{fig:Longevity:C} gap currents) and of corresponding integrated charge~\subref{fig:Longevity:D} of the irradiated RE2 chamber.}
	\end{figure}
\vfill
...
\newpage
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:rate-I-monitor} Example of rate~\subref{fig:rate-I-monitor:A} and current~\subref{fig:rate-I-monitor:B} monitoring of the irradiated RE2 chamber at working voltage in double gap mode (step 1) with increasing integrated charge.}
	\end{figure}
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:weekly-noise} Example of rates~\subref{fig:rate-I-monitor:A} and currents~\subref{fig:rate-I-monitor:B} of the irradiated and reference RE4 chambers measured during a weekly noise scan.}
	\end{figure}
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:weekly-source} Example of rates~\subref{fig:rate-I-monitor:A} and currents~\subref{fig:rate-I-monitor:B} of irradiated and reference RE4 chambers measured during a weekly source scan. The data were measured with ABS 123 (6.9).}
	\end{figure}
...
\endgroup
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:october-sig} Efficiency~\subref{fig:october-sig:A} and monitored currents of the bottom~\subref{fig:october-sig:B} and top narrow~\subref{fig:october-sig:C} gaps as a function of the effective voltage of the irradiated RE2 chamber during October 2018 testbeam period. The data are shown for source OFF and different absorption factors.}
	\end{figure}
...
\newpage
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:GIFpp-Ohmic-mon} Monitoring of the ohmic component of the dark current with increasing integrated charge at a voltage of \SI{6500}{V} of the RE2~\subref{fig:GIFpp-Ohmic-mon:A} and RE4~\subref{fig:GIFpp-Ohmic-mon:B} detectors installed at the GIF++.}
	\end{figure}
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:GIFpp-Dark-rate-mon} Monitoring of the physics component of the dark current and of the noise rate per unit area with increasing integrated charge at a voltage of \SI{9600}{V} for the RE2 detectors~\subref{fig:GIFpp-Dark-rate-mon:A} and~\subref{fig:GIFpp-Dark-rate-mon:C} and at a voltage of \SI{9500}{V} for the RE4 detectors~\subref{fig:GIFpp-Dark-rate-mon:B} and~\subref{fig:GIFpp-Dark-rate-mon:D} installed at the GIF++.}
	\end{figure}
...
\normalsize
	...
	\begin{figure}[H]
    	...
    	\end{subfigure}
		\caption{\label{fig:GIFpp-Ratios-mon} "Irradiated over Reference" parameter ratios (current densities, gamma rates and resistivities) as a function of the integrated charge for the RE2~\subref{fig:GIFpp-Ratios-mon:A} and the RE4~\subref{fig:GIFpp-Ratios-mon:B} detectors installed at the GIF++.}
	\end{figure}
...
\normalsize
	...
	Figures~\ref{fig:GIFpp_eff_vs_rate} and \ref{fig:GIFpp_cls_vs_rate} show the evolution of the efficiency and of the mean muon cluster size at working voltage with increasing background hit rate. There is no loss of rate capability to be observed. The efficiencies at working voltage show the same behaviour during the last testbeam period as during the previous ones as long as the background rate is below \SIrate{1000}. The efficiency of all four detectors does not decrease beneath 95\%. Beyond \SIrate{1000}, the data is not of interest anymore. Due to time constraints, the choice was often made to only make sure that all four chambers were irradiated at least to a background hit rate of \SIrate{600} corresponding to the certification threshold. The irradiated RE4 chamber is consistently the chamber for which the measured background hit rate is the lowest as can for example be seen in Figure~\ref{fig:GIFpp_eff_vs_rate:B}. At the occasion of three of the reported testbeam periods, the measured rate in this chamber didn't reach \SIrate{750}, when the rate seen by the other chambers is always at least of \SIkrate{1}.
