...
\label{chapt4:sec:signal}
	...
	Using Bethe formula to understand the mean energy transfer of charged particle when traveling through a gas volume give an intuition of the physics that affect the particle but doesn't provide a detailed enough information about the individual ionizations along its tracks at a microscopic level. In order to simulate efficiently and RPC and hence understand the processes that govern the avalanche creation and growth, knowledge on the ionization process is necessary.
