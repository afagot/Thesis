...
% Comand to call the L of luminosity
...
\bigskip
 ...
 \vspace{5mm}
   \begin{centering}
     \LARGE \textbf{\textsf{Consolidation and longevity of the CMS Resistive Plate Chamber system in view of the High-Luminosity LHC Upgrade}}\\
   \end{centering}
 \vspace{5mm}
 \hrule
% 
