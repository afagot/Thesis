...
\begin{acronym_expdlist}
	...
	\acro{GEANT}{GEometry ANd Tracking - \textit{a series of software toolkit platforms developed by CERN}}
	\acro{GEM}{Gas Electron Multiplier}
	\acro{GIF}{old Gamma Irradiation Facility dismantled in 2014}
...
\begin{acronym_expdlist}
	...
	\acro{ROOT}{\textit{a framework for data processing born at CERN}}
